...
export class VoucherReportsDatasource extends BaseDataSource {

    constructor(private reportService: ReportsService) {
        super();
    }

    loadVoucherList(queryParams: QueryParamsModel) {
        this.loadingSubject.next(true);
        this.reportService.voucherReports(queryParams).pipe(
